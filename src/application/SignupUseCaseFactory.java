...
public class SignupUseCaseFactory {
    ...
    public static SignUpView create(
            ...
            userDataAccessObject) throws IOException {

           try{ SignUpController signupController = createUserSignupUseCase(viewManagerModel, signupViewModel, userDataAccessObject);
